...
export default {
  ...
  '3.3': {
    ...
    theorie: [
      ...
      {
        keyTerms: ['bewijs', 'deepfake', 'bron', 'context'],
        exampleHtml: [
  ...
  '3.4': {
    ...
    theorie: [
      ...
      {
        keyTerms: ['bewijs', 'blokkeer', 'toestemming', 'mentor'],
        exampleHtml: [
  ...
  '3.6': {
    learningGoals: [
      'Je kunt bij een online situatie eerst stoppen en het risico inschatten.',
      'Je kunt een veilige keuze maken en uitleggen waarom je die maakt.',
      'Je weet wanneer je hulp vraagt aan een volwassene.'
    ],
    theorie: [
      // theorieblok 1: Eerst denken, dan klikken
      {
        keyTerms: ['stop', 'risico', 'mediawijs', 'cyberpesten'],
        exampleHtml: [
      ...
      {
        keyTerms: ['casus', 'misgaan', 'nadenkt'],
        exampleHtml: [
